...
module.exports = INHERIT(/** @lends Arch.prototype */ {
    ...
    /**
     * Create and return default node for specified ID.
     *
     ...
     * @param [parents] {String[]|String} Node parents to link with
     * @param [children] {String[]|String} Node children to link with
     ...
     *
     * @param node {Object} Node to add or replace
     * @param [parents] {String[]|String} Node parents to link with
     * @param [children] {String[]|String} Node children to link with
     * @return {Arch} Chainable API.
     */
