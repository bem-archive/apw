...
module.exports = INHERIT(EventEmitter, /** @lends Plan.prototype */ {
    ...
    injectSubArch: function(child, parent) {
        ASSERTS.idTypeString(child);
        ASSERTS.idTypeString(parent);
        ASSERTS.oneOfTwoInPlan(child, parent, this);
        ASSERTS.notJob(child, this);
        ASSERTS.notJob(parent, this);
    ...
    unlink: function(id1, id2) {
        ASSERTS.idTypeString(id1);
        ASSERTS.idTypeString(id2);
