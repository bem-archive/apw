...
module.exports = INHERIT(EventEmitter, /** @lends Plan.prototype */ {
    ...
    toJson: function() {
        var nodesIds = Object.keys(this.arch.nodes),

            links = Object.keys(this.children)
                .filter(function(parent) {
                    return this.children[parent] && this.children[parent].length > 0;
                }, this)
                .map(function(parent) {
        ...
        return '{"nodes":[\n' +
            nodesIds.map(function(r) {
                return this.arch.getNode(r).toJson(r);
