...
module.exports = INHERIT({
    ...
    addJob: function(id) {
        if (!this.activeJobs[id] && this.jobs.indexOf(id) === -1) this.jobs.push(id);
    },
    ...
    onPlanFinish: function() {
        this.graph.unregisterPlan(this);
    },

    allDone: function() {
        return (!this.locked && !this.jobs.length && !this.children[this.root].length);
    },
