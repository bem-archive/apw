...
var a = graph.addNode(newNode('A', function(cb) {
        console.log('async run(A)');
        setTimeout(function() {
            console.log('done(A)');
            cb(10);
        }, 2000);
    ...
    d1 = graph.addNode(newNode('D1',function(cb) {
        console.log('async run(D1)');
        setTimeout(function() {
            console.log('done(D1)');
            cb(50);
        }, 2000);
    ...
    e2 = graph.addNode(newNode('E2', function(cb) {
        console.log('async run(E2)');
        setTimeout(function() {
            console.log('done(E2)');
            cb(80);
        }, 2000);
...
chunks.fillChunks(graph.getSubGraph(a, f2));
console.log('=========\nINITIAL CHUNKS\n---------');
